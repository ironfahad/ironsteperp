...
// 		if($_SESSION["wa_current_user"]->username =='ansar' ){
//   $go_debug = 1;
//  }
//  else{
//       $go_debug= 0;
//  }
	...
	// Main Title
	$app_title = "Ironstep Design ERP";

	// Build for development purposes
	$build_version 	= date("d.m.Y", filemtime("$path_to_root/CHANGELOG.txt"));

	// Powered by
	$power_by 		= "Ironstep Design";
	$power_url 		= "http://www.ironstepdesign.com";
	...
	// 	context help feed from ironstepdesign.com
	$help_base_url = 'http://ironstepdesign.com/erphelp';
