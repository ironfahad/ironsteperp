...
function print_deliveries()
{
	...
	$cols = array(4, 60, 225, 300, 325, 385, 450, 495);
	...
	for ($i = $from; $i <= $to; $i++)
	{
			...
			{
				/*Total Quantity*/
				$rep->TextCol(4, 6, _("Quantity-total: ".$QuantityTotal."__________"), -2);
				
				// $rep->TextCol(1, 6, _("Quantity-total"), -2);
				// $rep->TextCol(6, 7,	$QuantityTotal, -2);
				// $rep->TextCol(6, 7,	$QuantityTotal, -2);
				/*End Total Quantity*/
				// $rep->NewLine();
				// $rep->TextCol(1, 6, _("Sub-total"), -2);
				// $rep->TextCol(1, 6, _("Sub-total"), -2);
