...
page(_("Ironstep ERP Installation Wizard"), true, false, "", '', false, 'stylesheet.css');
...
function subpage_title($txt) 
{
	...
	echo '<center><img src="'.$path_to_root.'/themes/default/images/logo_ironstepdesign.png" width="250" height="50" alt="Ironstep ERP" >
		</center>';
	...
	display_heading(
		$page == 6 ? $txt :
			_("Ironstep ERP Installation Wizard").'<br>'
...
start_form();
	switch(@$_POST['Page']) {
		...
		case '6': // final screen
			subpage_title(_('Ironstep ERP has been installed successsfully.'));
